...
// Shared shell for login + register. Centers a constrained card on the dark
// background and shows the brand. The vinyl record is the page signature.
...
// A small CSS-only spinning record. Disabled under reduced-motion.
function Vinyl() {
  return (
